      ...
      passage-wrapped = passage-with-rage.overrideAttrs (attrs: {
        postInstall = (
          ...
          (x: if strings.hasInfix "wrapProgram" x then
                x+ " --set-default PASSAGE_DIR ${../../../secrets/passage/joel} --set-default PASSAGE_IDENTITIES_FILE ${../../../secrets/age-identities/age-yubikey-5c-primary-identity-c8d44732.pub}"
              else
                x
          )
          (strings.splitString "\n" attrs.postInstall)
