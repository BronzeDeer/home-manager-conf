{config,pkgs,lib,...}:
{
    webappify.apps = [
        ...
        rec { url = "https://colenio.vertec-cloud.de/webapp/"; name = "Vertec"; icon = (builtins.fetchurl { url = "https://colenio.vertec-cloud.de/webapp/resource/1dacc710cdc8400/vertec/images/favicon.ico"; sha256="sha256:07q5pbm3gwpkfnsfnkm6ab0r5207nxlj7kwl7s04zlsw6g96n4ch";} );}
