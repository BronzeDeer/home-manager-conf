    ...
    mkCommon = ({pkgs,lib, ...}: with lib; {
      ...
      passage-wrapped = passage-with-rage.overrideAttrs (attrs: {
        postInstall = (
          ...
          (x: if strings.hasInfix "wrapProgram" x then # TODO Replace relative DIRs here based on config
      ...
      options = {
        secrets = {
          ...
          masterIdentityPubKey = mkOption {
            ...
            description = ''
              The public key of the master identity to encrypt against. If unset, the masterIdentityFile must be an unencrypted split-identity-file including a comment of the form `Recipient: <age-recipient>`,
              in this case, the pub key will be inferred automatically. This is the case for all yubikey identities generated by `age-plugin-yubikey`.
            '';
          };
          ...
          extraEncryptionPubkeys = mkOption {
            ...
            description = ''
              ...
              If the coerced value is not a path, interpret the string as being the recipient value (public key).
